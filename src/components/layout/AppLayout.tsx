  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        {!isPracticeScreen && (
          <header className="flex-shrink-0 px-5 lg:px-8 pt-5 pb-3 flex justify-between items-center z-10">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-accent/20 flex items-center justify-center text-accent lg:hidden">
        ...
        <div className={`flex-1 overflow-y-auto ${isPracticeScreen ? '' : 'px-5 lg:px-8 pb-24 lg:pb-8'}`}>
          <Outlet />
        </div>
      </main>
