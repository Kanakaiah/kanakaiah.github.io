export const ACTS_COMMENTARIES = {
  id: "acts-commentaries",
  title: "Acts of the Apostles Commentary Series",
  subtitle: "Critical-scholarly guides for the Book of Acts",
  icon: "🕊️",
  type: "reference",
  category: "Reference",
  sections: [
    ...
    {
      heading: "Acts: Core Commentaries",
      entries: [
