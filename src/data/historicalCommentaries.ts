export const HISTORICAL_COMMENTARIES = {
  ...
  sections: [
    ...
    },
    {
      ...
      entries: [
        { rank: "NAC", person: "Daniel Block, Judges, Ruth", quote: "The gold standard for evangelical exegesis of Judges.", note: "Block's sensitivity to narrative art and rhetorical structure is exceptional. Essential for preaching." },
    ...
    },
    {
      ...
      entries: [
        { rank: "NAC", person: "Daniel Block, Judges, Ruth", quote: "Block's Ruth section is among the finest short treatments of any book." },
        { rank: "WBC", person: "Frederic Bush, Ruth/Esther", quote: "The most technically rigorous Hebrew treatment; indispensable.", note: "Bush's linguistic analysis of the Hebrew is unrivaled. Highest recommendation for technical work." },
    ...
    },
    {
      ...
      entries: [
        { rank: "NICOT", person: "David Tsumura, The First Book of Samuel", quote: "The best Hebrew-philological treatment of 1 Samuel.", note: "Tsumura is essential for any serious Hebrew work on Samuel. His interaction with ANE parallels is unmatched." },
    ...
    },
    {
      ...
      entries: [
        ...
        { rank: "BCOTWP", person: "Baker Commentary on the Old Testament: Wisdom & Psalms", quote: "Strong philological series, underrated." }
      ]
    }
  ]
};
