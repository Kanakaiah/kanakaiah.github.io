...
const content = fs.readFileSync('src/data/otGuides/psalms.ts', 'utf8');
...
fs.writeFileSync('C:/Users/etipa/.gemini/antigravity/brain/c4e0d273-1f10-4c43-ad02-d1d0b66b3d91/psalms_prompts.md', md);
